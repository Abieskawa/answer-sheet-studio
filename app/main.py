...
I18N = {
    "zh-Hant": {
        ...
        "result_download_annotated": "標示圖案",
        "result_download_analysis_pdf": "下載分析結果 PDF",
        "result_download_showwrong": "僅顯示錯題(含總分)",
        ...
        "result_download_scores_by_class": "各班分數",
...
def _analysis_file_links(job_id: str) -> list[dict]:
    ...
    label_by_name = {
        "roster.csv": "學生資訊",
        # "analysis_template.csv": "analysis_template.csv",  # Hidden per request
        "analysis_scores.csv": "全部學生分數",
        "analysis_scores_by_class.xlsx": "各班分數",
        "analysis_item.csv": "試題分析",
        "analysis_summary.csv": "分數統計",
        "analysis_score_hist.png": "成績分佈圖",
        "analysis_item_plot.png": "試題分析圖",
    }
